...
- **VERSION**: la versione dello standard con cui vogliamo che il server ci risponda,  nel caso di QGIS le versioni didponibili sono la **1.3.0** e **la 1.1.0**
...
- **MAP**: `non è un paramentro standard, ma è un parametro specifico per QGIS-Server e contiene il path e il nome del progetto qgis da utilizzare`
...
- **Estensione pubblicata**: definisce se attivata l'estezione massima a cui il server può rispondere
